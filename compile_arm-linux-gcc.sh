...
do
    ...
    mkdir 1
    echo "Command used to compile: \`arm-linux-gcc -static ...\`" > ./1/README.md
    ...
    mkdir 2
    echo "Command used to compile: \`arm-linux-gcc -static -march=armv5 ...\`" > ./2/README.md
    ...
    mkdir 3
    echo "Command used to compile: \`arm-linux-gcc -static -marm -O0 ...\`" > ./3/README.md
    ...
    mkdir 4
    echo "Command used to compile: \`arm-linux-gcc -static -marm -O1 ...\`" > ./4/README.md
    ...
    mkdir 5
    echo "Command used to compile: \`arm-linux-gcc -static -marm -O2 ...\`" > ./5/README.md
    ...
    mkdir 6
    echo "Command used to compile: \`arm-linux-gcc -static -marm -O3 ...\`" > ./6/README.md
    ...
    mkdir 7
    echo "Command used to compile: \`arm-linux-gcc -static -marm -Os ...\`" > ./7/README.md
